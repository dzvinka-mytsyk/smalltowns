...
function formatDirections(gdir, mode) {
  ...
  for (var i = 0; i < gdir.legs.length; ++i) {
    ...
    var colour = "g";
    var number = i + 1;
    retStr += "\t<tr class='heading'><td class='heading' width=40>" + "<div class='centered-directions'><img src='iconsnew/black" + number + ".png'></div></td>" + "<td class='heading'><div class='centered-directions'>";
    var headerStr;
    ...
    dragStr += "<li id='" + i + "' class='ui-state-" + (i ? "default" : "disabled") + "'>" + "<table class='dragTable'><tr><td class='left'><img src='iconsnew/black" + number + ".png' /></td><td class='middle'>" + headerStr + "</td><td class='right'>" + (i ? "<button id='dragClose" + i + "' value='" + i + "'></button>" : "") + "</td></tr></table></li>";
    if (i == 0) {
    ...
    for (var j = 0; j < route.steps.length; ++j) {
      ...
      retStr += "\t<tr class='text'><td class='" + classStr + "'></td>" + "<td class='" + classStr + "'>" + route.steps[j].instructions + "<div class='left-shift'>" + route.steps[j].distance.text + "</div></td></tr>\n";
    }
  }
  ...
  if (mode == 0) {
    ...
    dragStr += "<li id='" + 0 + "' class='ui-state-disabled'>" + "<table class='dragTable'><tr><td><img src='iconsnew/black" + 1 + ".png' /></td><td>" + headerStr + "</td></tr></table></li>";
    retStr += "\t<tr class='heading'><td class='heading'>" + "<div class='centered-directions'><img src='iconsnew/black1.png'></div></td>" + "<td class='heading'>" + "<div class='centered-directions'>" + headerStr + "</div></td></tr>\n";
  } else if (mode == 1) {
    var headerStr;
    ...
    retStr += "\t<tr class='heading'><td class='heading'>" + "<div class='centered-directions'><img src='iconsnew/black" + (gdir.legs.length + 1) + ".png'></div></td>" + "<td class='heading'>" + "<div class='centered-directions'>" + headerStr + "</div></td></tr>\n";
  }
  dragStr += "</ul>";
  retStr += "</table>";
  retArr[0] = dragStr;
...
function drawMarker(latlng, addr, label, num) {
  ...
  google.maps.event.addListener(marker, 'click', function(event) {
    ...
    var infoWindow = new google.maps.InfoWindow({
      content: labelStr + addrStr + "<a href='javascript:setMarkerAsStart(markers[" + markerInd + "]" + ")'>" + "Set as starting location" + "</a><br>" + "<a href='javascript:setMarkerAsStop(markers[" + markerInd + "])'>" + "Set as ending location" + "</a><br>" + "<a href='javascript:removeMarker(markers[" + markerInd + "])'>" + "Remove location</a>",
...
function onSolveCallback(myTsp) {
  ...
  document.getElementById("durationsData_hidden").innerHTML =
    "<textarea name='csvDurationsMatrix' rows='10' cols='40'>" + durationsMatrixStr + "</textarea><br>";
}
